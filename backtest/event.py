...
# Event : the fundamental class unit of the event-driven system. 
# It contains a type (such as "MARKET", "SIGNAL", "ORDER" or "FILL") 
# that determines how it will be handled within the event-loop.

# Event Queue - The Event Queue is an in-memory Python Queue object that stores 
# all of the Event sub-class objects that are generated by the rest of the software.
